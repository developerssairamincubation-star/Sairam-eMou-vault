...
// Department codes
export type DepartmentCode = 'CSE' | 'ECE' | 'MECH' | 'CIVIL' | 'EEE' | 'IT' | 'AIDS' | 'CSBS' | 'E&I' | 'MECHATRONICS' | 'CCE' | 'AIML' | 'CYBERSECURITY' | 'IOT' | 'EICE' | 'CSE MTECH'| 'MECH AND AUTO' | 'Institution' | 'Incubation' | 'Mathematics' | 'MBA' | 'UBA' | 'Innovation Ecosystem';
