        ...
        <div className="p-6">
          ...
          {activeTab === "drafts" && (
            <div>
              ...
              {renderRecordTable(draftRecords, true)}
            </div>
          )}
          ...
          {activeTab === "approved" && (
            <div>
              ...
              {renderRecordTable(approvedRecords, false)}
            </div>
          )}
        </div>
